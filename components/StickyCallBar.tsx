 ...
 *
 * The tap pushes to the existing Google Tag Manager dataLayer so emergency
 * calls can be counted as a conversion.
 */
  ...
  return (
    <a
      ...
      onClick={() => {
        ...
        window.dataLayer.push({ event: 'emergency_call_click' })
      }}
    >
