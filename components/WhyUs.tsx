    ...
    <section className="section why">
      <div className="container">
        <div className="section-head reveal">
          <span className="eyebrow center">Why St Kilda East Families Choose Us</span>
        ...
        <div className="why-grid" data-stagger>
          <div className="pillar reveal">
            ...
            <p>Since 1984, we've grown alongside the St Kilda East community — caring for parents, then their children, then their grandchildren. Real continuity, real trust.</p>
          </div>
