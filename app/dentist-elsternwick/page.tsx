...
const data = getSuburb('elsternwick')!
      ...
      <section className="hero-v2">
        <div className="container hero-v2-grid">
          <div className="reveal">
            <div className="eyebrow">Your local dentist near Elsternwick</div>
            <h1>Gentle dental care, <em>close to Elsternwick</em></h1>
        ...
        <div className="container">
          <div className="sec-head center reveal">
            ...
            <p style={{ marginTop: '16px', fontSize: '16px' }}>
              Approximately {data.distance} from Elsternwick.<br />
