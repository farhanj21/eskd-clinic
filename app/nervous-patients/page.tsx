      ...
      <section className="sec alt">
        <div className="container reveal" style={{ textAlign: 'center', maxWidth: '46em' }}>
          ...
          <p style={{ fontSize: '18px', marginTop: '14px' }}>
            Cost worries can be as stressful as the dentistry itself. You&apos;ll always get a clear written estimate before anything goes ahead, your first visit is our New Patient Comprehensive Care Visit at one simple price with everything included, and we offer payment plans for larger treatment. Nothing is a surprise.
          </p>
